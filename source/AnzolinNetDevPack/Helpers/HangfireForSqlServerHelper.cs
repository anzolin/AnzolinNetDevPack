...
{
    public static class HangfireForSqlServerHelper
    {
        public static SqlServerStorage Storage { get; set; }
        ...
        /// <returns></returns>
        public static JobDetailsDto GetJobDetails(SqlServerStorage storage, string jobId)
        {
            JobStorage.Current = storage;
        ...
        /// <param name="jobId"></param>
        /// <returns></returns>
        public static object GetJobResult(SqlServerStorage storage, string jobId)
        {
            JobStorage.Current = storage;
